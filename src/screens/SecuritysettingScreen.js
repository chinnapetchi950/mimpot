...
/>
      <View style={{ paddingHorizontal: wp("5%"), paddingTop: hp("3%") }}>
        ...
        <TouchableOpacity style={{ flexDirection: "row", alignItems: "center", marginTop: hp("2%") }} onPress={() => navigation.navigate("ChangePassword")}>
          <Ionicons name="key" size={26} color="#42B5E8" />
        ...
        <TouchableOpacity style={{ flexDirection: "row", alignItems: "center", marginTop: hp("3%") }} onPress={() => {setShowModal(true)}}>
          <Ionicons name="person-remove" size={26} color="#42B5E8" />
...
//       <View style={{ paddingHorizontal: ui.spacing.md, paddingTop: ui.spacing.lg }}>
//         {/* Section Title */}
//         <Text style={{ fontWeight: "700", fontSize: ui.font.h3 }}>
//           {t("security.general")}
//         </Text>

//         {/* Change Password */}
//         <TouchableOpacity
//           style={{ flexDirection: "row", alignItems: "center", marginTop: ui.spacing.lg }}
//           onPress={() => navigation.navigate("ChangePassword")}
//         >
//           <Ionicons name="key" size={ui.font.h2} color="#42B5E8" />
//           <Text style={{ marginLeft: ui.spacing.sm, fontSize: ui.font.body }}>
...
//         {/* Delete Account */}
//         <TouchableOpacity
//           style={{ flexDirection: "row", alignItems: "center", marginTop: ui.spacing.xl }}
//           onPress={() => setShowModal(true)}
//         >
//           <Ionicons name="person-remove" size={ui.font.h2} color="#42B5E8" />
//           <Text style={{ marginLeft: ui.spacing.sm, fontSize: ui.font.body }}>
...
//         {/* Terms & Privacy */}
//         <TouchableOpacity onPress={() => navigation.navigate("Terms")}>
//           <Text style={{ fontWeight: "700", marginTop: ui.spacing.xl, fontSize: ui.font.h3 }}>
//             {t("security.terms_and_conditions")}
//           </Text>
//         </TouchableOpacity>

//         <TouchableOpacity onPress={() => navigation.navigate("Privacy")}>
//           <Text style={{ fontWeight: "700", marginTop: ui.spacing.lg, fontSize: ui.font.h3 }}>
